...
FloGrain2 {
	...
	*ar {
		...
		size=0.1, rSize = 0, speed=1,start=0,end=1, rPos=0,pan=0,rPan=0,
		amp=1, rAmp = 0,rAmpSpeed=1,win = -1;

		var info, impulse, freqmod, posrand, densemod, sizemod, ampmod, panmod, head, sound;
		...
		head = Phasor.ar(1, (BufRateScale.kr(buf)*speed) / info, start, (start+end)); //readhead for Grainbufs pos argument. (bufSize*speed)/bufFrames is "realtime"
